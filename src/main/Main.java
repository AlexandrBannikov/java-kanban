...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // Создание
        Task task1 = new Task("Task #1, финальное задание Яндекс практикум", "Task1 description", Status.NEW);
        Task task2 = new Task("Task #2", "Task2 description", Status.NEW);
        ...
        Epic epic2 = new Epic("Epic #2", "Epic2 description",Status.NEW);
        int epicId1 = manager.addNewEpic(epic1);
        int epicId2 = manager.addNewEpic(epic2);

        Subtask subtask1 = new Subtask("Subtask #1 - 1", "Subtask 1 description", Status.NEW, epicId1);
        Subtask subtask2 = new Subtask("Subtask #2 - 1", "Subtask 2 description", Status.NEW, epicId1);
        Subtask subtask3 = new Subtask("Subtask #3 - 2", "Subtask 3 description", Status.NEW, epicId2);
